...
let results = searchingInfo.toUpperCase()
    ...
    render() {
        ...
        let myfriendList = this.state.myFriendsList
        

        let friendsMapped = myfriendList.map((friends, index) => {
                ...
                return (
                    <div key={index} className="profile_list">
                        ...
                        <div className="profile_name">
                            <div>Friend Name</div>
                            <br />
                            <div>Friend Last Name</div></div>
                        {this.state.friendMatch === friends.helo_friend_id ?
                            <button onClick={() => { this.removeFriend(friends.id) }} className="remove_friend">Remove Friend</button>:
                            <button onClick={() => { this.addFriend(friends.id) }} className="add_friend">Add Friend</button> 
                        }
            ...
            <div>
                ...
                <div className="main-container">
                    <div className="searchable-friends">
                        ...
                        <div className='flex-me'>{profilesMapped}{friendsMapped}</div>
